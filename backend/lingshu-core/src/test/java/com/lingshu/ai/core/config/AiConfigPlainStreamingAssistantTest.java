...
class AiConfigPlainStreamingAssistantTest {

    @Test
    void plainStreamingAssistant_shouldInjectSystemPromptWithChatMemoryProvider() {
        ...
        AiConfig.PlainStreamingAssistant assistant = AiServices.builder(AiConfig.PlainStreamingAssistant.class)
                .streamingChatModel(model)
                .chatMemoryProvider(memoryProvider)
                .systemMessageProvider(memoryId -> "system prompt")
                .build();

        assistant.chat(1L, "你好")
