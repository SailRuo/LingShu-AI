...
public interface FactSemanticClassifier {
    ...
    @SystemMessage("""
            ...
            允许的 topicKey 只有：
            interest, growth, goal, emotion, relationship, event, timeline, memory

            允许的 subType 只有：
            Preference, EmotionState, Person, Project, Goal, Event, TimeAnchor, Memory
            ...
            5. 如果内容主要描述人际对象或关系，使用 relationship / Person。
            6. 如果内容主要描述工作、项目、学习任务，优先 growth / Project。
            7. 如果内容主要描述目标、打算、计划，优先 goal / Goal。
            8. 如果内容主要描述时间锚点、最近安排、短期时间线，优先 timeline / TimeAnchor。
            9. 如果内容主要描述某个发生过的事件，优先 event / Event。
            10. 如果无法明确判断，返回 memory / Memory。
