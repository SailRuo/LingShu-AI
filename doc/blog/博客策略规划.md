...
1. 《我如何用 Java 打造了一个懂你的本地化 AI 伴侣》
2. 《隐私至上！手把手教你构建离线版个人 AI 助手》
3. 《具备长期记忆的 AI 是什么体验？这个项目给出了答案》
4. 《Java 21 + Spring Boot 3 + LangChain4j：从零开始构建 AI 伴侣》
...
pgvector, 本地化 AI, 开源 AI 项目，AI 伴侣，
记忆系统，RAG 检索
```
