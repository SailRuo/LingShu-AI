...
> 日期: 2026-04-14  
> 状态: **已实施**  
> 更新说明: 补全全栈视角下的前端“记忆治理”与“记忆图谱”表现层架构
...
5. **富上下文提取 (Context-Rich Extraction)**：确保每个事实片段包含完整的地点、对象和前置条件，避免语义碎片化
6. **逻辑依存关系 (Logical Dependency)**：引入 `DEPENDS_ON` 关系，支持记忆链条的联级冲突处理和生命周期同步
...
│  │  • 关系维护：RELATED_TO, SUPERSEDES, CONTRADICTS, DEPENDS_ON      │    │
│  └──────────────────────────────────────────────────────────────────┘    │
│                                                                              │
│    ══════════════════════════════════════════════════════════════════════   │
│                                                                              │
...
│    │                                                                    │   │
│    │ • 活跃度计算：分段阶梯衰减 (0.96@6h, 0.84@24h, 0.34@30d)            │   │
